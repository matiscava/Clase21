...
const desnormalizedEmpresa = denormalize(normalizedEmpresa.result, organigrama,normalizedEmpresa.entities);
print(desnormalizedEmpresa);

console.log('Longitud objeto original: ', JSON.stringify(empresa).length);
console.log('Longitud objeto desnormalizado: ', JSON.stringify(desnormalizedEmpresa).length);
